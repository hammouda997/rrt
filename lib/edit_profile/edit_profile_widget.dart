                ...
                print("aw chyjib urls");
                            ...
                            if (selectedUploadedFiles.length ==
                              ...
                              setState(() {
                                ...
                                print(_model.uploadedFileUrl);

                                FirebaseFirestore.instance.doc('users/'+FirebaseAuth.instance.currentUser!.uid).update({"imageUrl":_model.uploadedFileUrl}).then((value) => print("c bon mrigel"));
